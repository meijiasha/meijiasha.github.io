                ...
                >
                    ...
                    >
                        ...
                        >
                            <path
                                fill="#06C755"
                                d="M21.15 9.03c-.27-4.88-4.48-8.8-9.58-8.77C5.55.3 1.05 5.13 1.05 11.1c0 3.32 1.94 6.25 4.96 7.93-.15.86-.53 2.1-1.07 3.03-.26.46-.08.87.35.91.43.04 2.82-.44 5.37-2.67.62.08 1.25.13 1.88.1 5.79-.27 10.45-5.02 10.45-10.83 0-3.32-1.93-9.42-1.84-10.54z"
                            />
                            <path
                                fill="#FFFFFF"
                                d="M18.82 12.35c.19.0.35-.15.35-.35V9.48c0-.1-.08-.18-.18-.18h-2.12c-.1-.0-.18.08-.18.18v2.69.01c0 .19.16.35.35.35.19.0.35-.16.35-.35v-2.35h1.76c.1.01.18-.07.18-.17v-.01zm-5.12.35c.19.0.35-.15.35-.35V8.58c0-.19-.16-.35-.35-.35s-.35.16-.35.35v3.42c.0.19.16.35.35.35zM8.3 12.35c.19.0.35-.15.35-.35V9.48c0-.1-.08-.18-.18-.18H6.35c-.1-.0-.18.08-.18.18v2.69.01c0 .19.16.35.35.35.19.0.35-.16.35-.35v-2.35H8.3c.09-.0.17-.07.17-.16v-.02.01c.0-.09-.07-.16-.16-.16H6.18c-.19.0-.35.16-.35.35v2.87c0 .19.15.35.34.35H8.3zm3.76-2.52l-1.63-1.6V12c0 .19-.16.35-.35.35s-.35-.16-.35-.35V8.58c0-.19.16-.35.35-.35.08.0.16.03.21.09l1.63 1.59V8.58c0-.19.16-.35.35-.35s.35.16.35.35v3.42c0 .19-.16.35-.35.35-.08.0-.15-.03-.21-.08l.00-.01z"
                            />
                        </svg>
                    </a>
                </Button>
